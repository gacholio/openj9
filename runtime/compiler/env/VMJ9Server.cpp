...
TR_J9ServerVM::getCurrentLocalsMapForDLT(TR::Compilation *comp)
   ...
   jitConfig->javaVM->localMapFunction(_portLibrary, currentMethod->romClassPtr(), currentMethod->romMethod(), comp->getDltBcIndex(), (U_32 *)currentBundles, NULL, NULL, NULL, NULL, NULL);
#endif
