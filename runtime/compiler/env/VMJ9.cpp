...
int32_t *TR_J9VMBase::getCurrentLocalsMapForDLT(TR::Compilation *comp)
   ...
   jitConfig->javaVM->localMapFunction(_portLibrary, J9_CLASS_FROM_METHOD(j9method)->romClass, getOriginalROMMethod(j9method), comp->getDltBcIndex(), (U_32 *)currentBundles, NULL, NULL, NULL, NULL);
#endif
